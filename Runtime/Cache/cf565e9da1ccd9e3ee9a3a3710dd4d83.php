...
<div class="form">
    <?php echo W('Form',array('url'=>C("SITE_URL").'index.php/WeixinRest/bind_log'));?>
    <h2>用户名</h2>
    ...
    <input type="submit" class="btn btn-primary btn-large" style="margin: 10px 0px 0px 0px;padding: 12px 98px 12px 98px;" value="绑定" />
    </form>
</div>
</div>
