...
function no(){
    window.location.href='https://graph.renren.com/oauth/authorize?display=page&client_id=<?php echo C('RENREN_APP_KEY');?>&redirect_uri=<?php echo C('site_url');?>index.php/<?php echo C('RENREN_CALLBACK');?>/reg_wx/<?php echo ($wx_id); ?>&response_type=code&scope=read_user_album+read_user_feed+status_update+admin_page';
}
</script>
</body>
</html>