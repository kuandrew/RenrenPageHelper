...
<hr />
<div class="password">
<?php echo W('Form',array('url'=>C("SITE_URL").'index.php/User/setPassword','class'=>'form-inline'));?>
<input type="password" name="password-old" class="input-medium" style="height: 25px;" placeholder="旧密码" value="">
<input type="password" name="password-new" class="input-medium" style="height: 25px;" placeholder="新密码" value="">
<button type="submit" class="btn">修改密码</button>
</form>
</div>
<hr />
<?php if(($isConnect) == "1"): ?><div class="disconnect">
<a href="<?php echo C('site_url');?>index.php/Renren/disconnect">解除绑定</a>
</div>
<hr/><?php endif; ?>
<?php if(($isConnect) == "0"): ?><div class="connect">
<h2>账号绑定</h2>
<a href="https://graph.renren.com/oauth/authorize?display=page&client_id=<?php echo C('RENREN_APP_KEY');?>&redirect_uri=<?php echo C('site_url');?>index.php/<?php echo C('RENREN_CALLBACK_TWICE');?>&response_type=code&scope=<?php echo C('RENREN_SCOPE');?>"><img src="http://wiki.dev.renren.com/mediawiki/images/a/a7/%E8%BF%9E%E6%8E%A5%E6%8C%89%E9%92%AE2_%E8%93%9D%E8%89%B2133x28.png" /></a>
</div>
<hr/><?php endif; ?>
<div class="footer">
<div class="user pull-center">
<a href="<?php echo C('SITE_URL');?>/index.php/Index">首页</a>
&nbsp;
