...
<div class="container pull-center"><div class="title" style="margin: 50px;"><h1>注册页</h1></div>
<div class="form">
    <?php echo W('Form',array('url'=>C("SITE_URL").'index.php/User/noaccessreg'));?>
    <h2>用户名</h2>
    <input name="noaccess" value="1" style="display: none;" />
    ...
    <input type="submit" class="btn btn-primary btn-large" style="margin: 10px 0px 0px 0px;padding: 12px 86px 12px 86px;" value="注册" />
    </form>
</div>
</div>
