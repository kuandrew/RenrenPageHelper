...
<div class="title" style="margin: 50px 0px 20px 0px;">
<h1>公共主页手机助手</h1>
</div>
...
<?php echo W('Form',array('url'=>C("SITE_URL").'index.php/Renren/setStatus','class'=>'form-inline'));?>
<input name="page_id" style="display: none;" value="<?php echo ($page['id']); ?>" />
<b>发状态</b>&nbsp;<input name="status" type="text" style="height: 30px;" />

<input class="btn btn-primary" type="submit" style="height: 30px;" value="发布" />
</form>
</div>
</div>
<hr />
